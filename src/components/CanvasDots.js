const CanvasDots = function () {
    const canvas = document.querySelector('canvas'),
        ...
        colorDot = [
            ...
            'rgb(0, 255, 128)', // Green
            'rgb(0, 255, 255)', // Teal
            'rgb(253, 187, 45)', // Yellow
            'rgb(55, 207, 215)', // Light Teal
        ],
        dotColor = 'rgb(55, 207, 215)',
        strokeColor = 'rgb(55, 207, 215)';
                ...
                for (let j = 0; j < dots.nb; j++) {
                    ...
                    if (
                        ...
                        if (
                            ...
                            ctx.strokeStyle = `rgb(0, 255, 255, ${1 - distanceRatio})`;
